...
import com.sberStudy.java.homeWork.pivovarova.lesson14.forExample.*;
...
public class ServiceImpl implements Service {
    ...
    @Override
    public Employee findEmployeeFromZip(int personalFileNumber) {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    @Override
    public Employee findEmployee(int personalFileNumber) {
        try {
            Thread.sleep(5000);
        } catch (InterruptedException e) {
            e.printStackTrace();
